...
<body>
    ...
    <div class="faq-info">
        <div class="faq-info-1">
            ...
            <ul> <button type="button" class="collapsible">Terms and Conditions</button>
                <div class="content">
                ...
                <button type="button" class="collapsible">Policy Terms</button>
                <div class="content">
                ...
                <button type="button" class="collapsible">Coverage</button>
                <div class="content">
