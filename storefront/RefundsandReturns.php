...
<body>
    ...
    <div class="faq-info">
        <div class="faq-info-1">
            ...
            <ul> <button type="button" class="collapsible">Returns</button>
                <div class="content">
                ...
                <button type="button" class="collapsible">Refunds</button>
                <div class="content">
                ...
                <button type="button" class="collapsible">Damaged Goods</button>
                <div class="content">
