...
<head>
    ...
    <link rel="stylesheet" href="storefront/style/headerfooterstyle.css?v=<?php echo time(); ?>">
    <script src="storefront/scripts/headerfooterscript.js" defer></script>
    <title>HEADER</title>
</head>
<body>
...
<nav id="dropdownnav">   
        ...
        <button onclick="shopBy()" class="dropdownbtn">Shop By</button>
            ...
            <a href="storefront/headerfooter.php" class="dropdownitem" id=find-a-planet>Find a Planet</a>
            </div>
        </div>

        <div class="dropdown">
            <a href="storefront/account.php"><button class="otherbtn" id="account">Account</button></a>
        </div>
